...
createServer({
    ...
    seeds(server) {
        ...
        server.create("car", { id: "12", name: "Crossover", price: 70, description: "Crossovers combine features of SUVs and passenger cars. They offer a higher driving position like an SUV but are built on a car platform, providing a more comfortable ride. Crossovers are versatile vehicles that appeal to a wide range of consumers, offering a good balance of space, fuel efficiency, and handling.", imageUrl: "/crossover.jpg", type: "luxury" })
    },
